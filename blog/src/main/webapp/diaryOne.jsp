...
<%@ include file="inc/header2.jsp"%>
	<div class="container-fluid">
		...
		<h1 style="text-color:white">DIARY_NO.<%=diaryNo%></h1>
		<hr>
		</div>
		<div>
			<table class="table table-primary table-bordered">
				...
				<tr>
					...
					<td colspan="8"><%=d.diaryNo%></td>
				</tr>
				<tr>
					<td colspan="2">날짜</td>
					<td colspan="8"><%=d.diaryDate%></td>
				</tr>
				<tr>
					<td colspan="2">내용</td>
					<td colspan="8"><%=d.diaryTodo%></td>
				</tr>
				<%
				}
				%>
		...
		<div>
			<a href="./updateDiary.jsp?diaryNo=<%=diaryNo%>" class="btn btn-dark" style="float:right;">수정</a>
			<a href="./deleteDiary.jsp?diaryNo=<%=diaryNo%>" class="btn btn-dark" style="float:right;">삭제</a>
		</div>
	</div>
